...
'''plotting the unprocessed image for comparision with 
the processed image later, this will not be uploaded to the cloud server'''
...
'''alpha & tolerance is a key component in the vertical analysis
    reduce alpha value to get more straight lines
    increase it to get more smooth curves
    increase tolerance to get more straight lines
    reduce it to get smooth curves
'''
